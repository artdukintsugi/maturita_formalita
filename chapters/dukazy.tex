...
\begin{example} 
  Představte si, že máte dokázat větu: \textit{Pokud je číslo $n^2$ sudé, tak je i $n$ sudé.} Zde zkusíme použít důkaz sporem. Provedeme obměněnou implikaci a dostanem výrok $\neg p \Rightarrow \neg q$. Tedy pokud je $n$ liché, tak je i $n^2$ liché. Toto jste již udělali ve cvičení~\ref{pr:1.4.4}.
\end{example}
